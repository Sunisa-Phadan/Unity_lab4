...
public class charactorMovement : MonoBehaviour
{
        ...
        void Update()
    {
        ...
        {
            animator.SetBool("Running", true);//ให้ทำการเคลื่อนไหว
            animator.SetBool("Moving", true);//ให้ทำการเคลื่อนไหว
        }
        else
        {
            animator.SetBool("Running", false);//กลับไปท่าพัก
            animator.SetBool("Moving", false);//กลับไปท่าพัก
        }
